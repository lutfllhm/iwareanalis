...
export class AccurateService {
  ...
  // cron.
  //
  // SEMPAT dinaikkan ke 150 untuk mempercepat backlog historis, tapi itu
  // memicu 429 (rate limit) beruntun dari Accurate API pada endpoint
  // sales-invoice/list.do — sejalan dengan alasan ACCURATE_CONCURRENCY
